...
function createProject(fixtureCsvFileName) {
  ...
  if (fixtureCsvFileName) {
    //Creates a new project using the given csv file

    //Clicks the New Project caret
    ...
    //Then goes to the Project Template page.
...
describe('AI QA Dev Interview Code Challenge - Cypress', function() {
  ...
  beforeEach(() => {
    ...
    //I don't remember why this is here -- could be unnecessary.
    cy.reload(true)
  })
